...
export function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      categoryKey: "Web",
      image: PlaceHolderImages.find(img => img.id === 'web-project')?.imageUrl,
    },
    {
      ...t.portfolio.projects[2],
      categoryKey: "App",
      image: PlaceHolderImages.find(img => img.id === 'app-project')?.imageUrl,
    },
    {
      ...t.portfolio.projects[3],
      categoryKey: "Design",
      image: PlaceHolderImages.find(img => img.id === 'design-project')?.imageUrl,
    },
  ];
  ...
  return (
    <section id="portfolio" className="py-24 bg-background transition-colors duration-300">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
          <div className="max-w-2xl mb-8 md:mb-0">
            <h2 className="text-sm font-bold text-accent uppercase tracking-widest mb-4">{t.portfolio.badge}</h2>
          ...
          {filteredProjects.map((project, idx) => (
            ...
            >
              <div className="relative h-80 overflow-hidden">
                <Image
                  src={project.image || "https://picsum.photos/seed/bisa/800/600"}
                  alt={project.title}
                  fill
              ...
              <div className="p-8">
                <Badge variant="secondary" className="mb-4 bg-accent/10 text-accent border-none rounded-full px-4">
                  {project.category}
                </Badge>
