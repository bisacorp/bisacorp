        ...
        <div className="space-y-8 max-w-2xl">
          <div className="space-y-4">
            <h1 className="text-5xl md:text-7xl font-headline font-extrabold text-primary leading-tight">
              {t.hero.title}{" "}
              <span className="text-accent">{t.hero.vision}</span>{" "}
              {t.hero.subtitle}
            </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button
              size="lg"
              asChild
              className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 h-14 text-lg rounded-full"
            >
              <Link href="/#services">
            ...
            <Button
              ...
              variant="outline"
              asChild
              className="px-8 h-14 text-lg rounded-full border-primary text-primary hover:bg-primary/5"
            >
