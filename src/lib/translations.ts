...
export const translations = {
  id: {
    ...
    hero: {
      ...
      description: "Kami spesialis dalam pengembangan web mutakhir, aplikasi seluler, model berbasis AI, dan desain khusus. Transformasikan bisnis Anda dengan teknologi yang stabil, profesional, dan inovatif.",
    ...
    services: {
      ...
      description: "BISA Corp menyediakan rangkaian layanan terintegrasi yang dirancang untuk memajukan bisnis Anda di lanskap digital yang kompetitif.",
      web: {
        title: "Pengembangan Web",
        desc: "Aplikasi web yang kokoh, terukur, dan responsif yang dibangun dengan teknologi terbaru.",
        features: ["Kustom React/NextJS", "Platform E-commerce", "Integrasi CMS"]
      },
      app: {
        title: "Pembuatan Aplikasi",
        desc: "Pengalaman seluler intuitif untuk iOS dan Android yang menarik dan mempertahankan pengguna.",
        features: ["Flutter Lintas Platform", "iOS/Android Native", "Optimasi UI/UX"]
      },
      ai: {
    ...
    aiExplainer: {
      ...
      description: "Tidak yakin bagaimana AI cocok dengan bisnis Anda? Masukkan jenis bisnis Anda, dan konsultan AI kami akan menghasilkan solusi khusus yang dirancang untuk Anda.",
      ...
      emptyState: "Lengkapi formulir untuk melihat bagaimana BISA Corp dapat mentransformasi bisnis Anda dengan AI."
    },
    contact: {
      badge: "Hubungi Kami",
      title: "Siap Membangun Sesuatu yang Luar Biasa?",
      description: "Apakah Anda memiliki proyek spesifik atau hanya ingin menjelajahi berbagai kemungkinan, tim kami siap membantu Anda menavigasi transformasi digital Anda.",
      ...
      form: {
        ...
        successDesc: "Kami telah menerima pertanyaan Anda dan akan segera menghubungi Anda."
      }
    },
    footer: {
      description: "BISA Corp Digital adalah mitra teknologi layanan lengkap yang membantu bisnis berkembang melalui perangkat lunak inovatif dan solusi desain ahli.",
    ...
    about: {
      ...
      mission: {
        ...
        items: ["Inovasi dengan Integritas", "Keunggulan Berpusat pada Pengguna", "Stabilitas Tanpa Kompromi", "Visi Global, Dampak Lokal"]
      },
      team: {
        badge: "Kepemimpinan Kami",
        title: "Para Pemikir di Balik BISA Corp",
        members: [
          { name: "Elena Rodriguez", role: "CEO & Pendiri" },
          { name: "Marcus Chen", role: "CTO" },
          { name: "Sarah Jenkins", role: "Kepala Desain" }
        ]
      }
    }
  },
  en: {
    ...
    hero: {
      ...
      description: "We specialize in cutting-edge web development, mobile applications, AI-based models, and custom design. Transform your business with stable, professional, and innovative technology.",
    ...
    services: {
      ...
      description: "BISA Corp provides an integrated suite of services designed to propel your business forward in the competitive digital landscape.",
      web: {
        title: "Web Development",
        desc: "Robust, scalable, and responsive web applications built with the latest technologies.",
        features: ["Custom React/NextJS", "E-commerce Platforms", "CMS Integration"]
      },
      app: {
        title: "App Creation",
        desc: "Intuitive mobile experiences for iOS and Android that engage and retain users.",
        features: ["Cross-platform Flutter", "Native iOS/Android", "UI/UX Optimization"]
      },
      ai: {
    ...
    aiExplainer: {
      ...
      description: "Not sure how AI fits into your business? Enter your business type, and our AI consultant will generate custom solutions designed for you.",
      ...
      emptyState: "Complete the form to see how BISA Corp can transform your business with AI."
    },
    contact: {
      badge: "Contact Us",
      title: "Ready to Build Something Extraordinary?",
      description: "Whether you have a specific project in mind or just want to explore possibilities, our team is here to help you navigate your digital transformation.",
      emailTitle: "Email Us",
      waTitle: "WhatsApp Us",
      ...
      form: {
        ...
        successDesc: "We've received your inquiry and will get back to you shortly."
      }
    },
    footer: {
      description: "BISA Corp Digital is a full-service technology partner helping businesses grow through innovative software and expert design solutions.",
    ...
    about: {
      ...
      mission: {
        ...
        items: ["Innovation with Integrity", "User-Centric Excellence", "Uncompromised Stability", "Global Vision, Local Impact"]
      },
      team: {
        badge: "Our Leadership",
        title: "The Minds Behind BISA Corp",
        members: [
          { name: "Elena Rodriguez", role: "CEO & Founder" },
          { name: "Marcus Chen", role: "CTO" },
          { name: "Sarah Jenkins", role: "Head of Design" }
        ]
      }
    }
  }
